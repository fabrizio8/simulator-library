...
def test_even_and_my_name():
    ...
    assert not accepted(dfa_u, [1,2,3,4,5,6], trace=True)
...
def test_even_chars_and_divisible_by_3():
    ...
    assert not accepted(dfa_u, ['1','2','3','4','5'], trace=True)
    assert not accepted(dfa_u, ['5','5'], trace=True)
    assert not accepted(dfa_u, list(range(8)), trace=True)
    assert not accepted(dfa_u, ['1','3'], trace=True)
...
def test_divisible_by_3_and_first_last_x():
    ...
    assert not accepted(dfa_u, ['1','5'], trace=True)
